            ...
            <div className="max-w-5xl mx-auto px-4 py-8">
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                        Sube un video y deja que la IA genere automáticamente título, descripción, temas y más
                    </p>
                </div>
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="p-6 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                            Genera títulos, descripciones y keywords automáticamente
                        </p>
                    </div>
                    ...
                    <div className="p-6 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                            Detecta objetos, temas y contenido visual automáticamente
                        </p>
                    </div>
                </div>
            </div>
